"""
Django settings for the BizFlow config project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='bizflow_db'),
        'USER': config('DB_USER', default='bizflow_user'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'BizFlow API',
    'DESCRIPTION': 'Multi-tenant SaaS platform for enterprise project, task and team management.',
    'VERSION': '1.0.0',
